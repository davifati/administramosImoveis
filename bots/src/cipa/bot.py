...
from login_page import CipaLoginPage
from home_page import CipaHomePage
from download_page import CipaDownloadPage
...
class CipaBot:
    def __init__(self):
        ...
        self.driver = self.driver = WebDriverConfig.get_firefox_driver(
