...
const ENDPOINTS = {
    ...
    MONITORAMENTO_ESTATISTICAS_MENSAIS_RESUMO_FALHAS: `${process.env.NEXT_PUBLIC_API_HOST}/${process.env.NEXT_PUBLIC_ENDPOINT_MONITORAMENTO_ESTATISTICAS_MENSAIS_RESUMO_FALHAS}` || null,
    MONITORAMENTO_ESTATISTICA_TOTAIS_FALHAS: `${process.env.NEXT_PUBLIC_API_HOST}/${process.env.NEXT_PUBLIC_ENDPOINT_MONITORAMENTO_ESTATISTICA_TOTAIS_FALHAS}` || null,
